...
public class UserController {
	...
	@GetMapping("/feedback")
	public String feredBack(Model model){
		model.addAttribute("feedback", new Feedback());
		return "feedback";
	}
	@PostMapping("/feedback")
	public String feedback(@Valid @ModelAttribute Feedback feedback,BindingResult result, Model model) {
		 if (result.hasErrors()) {
	            return "feedback";
	        }
	        fservice.savefdbk(feedback);
	        return "welcome";
	}
	...
	@GetMapping("/blog")
	public String blog(@RequestParam(value ="path",required = false,defaultValue = "")String path) {
		return "blog";
	}
